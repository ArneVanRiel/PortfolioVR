...
def aandelen_berekeningen():
    ...
    tickersWithFullData = checkForMinData.OntbrekendeData()[2]
    print(tickersWithFullData)
    ...
    for item in tickersWithFullData:
        ...
        if aandelen_data['fp'][0] == 'Q1' or aandelen_data['fp'][0] == 'Q2' or aandelen_data['fp'][0] == 'Q3' or aandelen_data['fp'][0] == 'FY' :
            aandelen_data['standaard_deviatie_ROE'] = aandelen_data['gemiddelde_stijging_ROE/Q'].rolling(40).std().shift(-39)
        ...
        aandelen_data['waardefactor_ROE'] = (aandelen_data['Gemiddelde_stijging_ROE_10_Y'] - 0.15) / (aandelen_data['standaard_deviatie_ROE'] * aandelen_data['standaard_deviatie_ROE'])
        ...
        if aandelen_data['fp'][0] == 'Q1' or aandelen_data['fp'][0] == 'Q2' or aandelen_data['fp'][0] == 'Q3' or aandelen_data['fp'][0] == 'FY' :
            aandelen_data['waardefactor_LTD_equity'] = (0.5/(0.5+aandelen_data['LTD_s_equity'].rolling(4).mean().shift(-3)))/0.5*2*(0.5/(0.5+aandelen_data['LTD_s_equity'].rolling(4).mean().shift(-3)))
        else:
        ...
        aandelen_data['toekomstige FCF +2Y'] = aandelen_data['StockholdersEquity'] * (1+ aandelen_data['gem_groeipercentage_FCF']) ** 2
        aandelen_data['toekomstige FCF +3Y'] = aandelen_data['StockholdersEquity'] * (1+ aandelen_data['gem_groeipercentage_FCF']) ** 3
        aandelen_data['toekomstige FCF +4Y'] = aandelen_data['StockholdersEquity'] * (1+ aandelen_data['gem_groeipercentage_FCF']) ** 4
        aandelen_data['toekomstige FCF +5Y'] = aandelen_data['StockholdersEquity'] * (1+ aandelen_data['gem_groeipercentage_FCF']) ** 5
        aandelen_data['toekomstige FCF +6Y'] = aandelen_data['StockholdersEquity'] * (1+ aandelen_data['gem_groeipercentage_FCF']) ** 6
        aandelen_data['toekomstige FCF +7Y'] = aandelen_data['StockholdersEquity'] * (1+ aandelen_data['gem_groeipercentage_FCF']) ** 7
        aandelen_data['toekomstige FCF +8Y'] = aandelen_data['StockholdersEquity'] * (1+ aandelen_data['gem_groeipercentage_FCF']) ** 8
        aandelen_data['toekomstige FCF +9Y'] = aandelen_data['StockholdersEquity'] * (1+ aandelen_data['gem_groeipercentage_FCF']) ** 9
        aandelen_data['toekomstige FCF +10Y'] = aandelen_data['StockholdersEquity'] * (1+ aandelen_data['gem_groeipercentage_FCF']) ** 10
        ...
        aandelen_data['intrinsieke_waarde'] = (aandelen_data['StockholdersEquity'] + aandelen_data['onderneming_10Y_FCF']) / aandelen_data['WeightedAverageNumberOfDilutedSharesOutstanding']
        ...
        selectiecriteria = aandelen_data[['alle FCF (jaar) >0', 'FCF sddev <0,25', 'FCF gemiddelde groei >0', 'FCF waardefactor >0', 'alle ROE >0', 'gem ROE (10Y) >15', 'ROE sddev <0,25','ROE waardefactor >0']].dropna()
        ...
        aandelen_data['waarde_verdeling1'] = aandelen_data['waardefactor_FCF'] * aandelen_data['waardefactor_ROE'] * aandelen_data['waardefactor_LTD_equity'] * aandelen_data['waardefactor_winstmarge'] * aandelen_data['waardefactor_dividend']
        aandelen_data['waarde_verdeling_tov_min1'] = aandelen_data['waarde_verdeling1']/aandelen_data['waarde_verdeling1'].shift(-1) -1
        aandelen_data['waarde_verdeling_stdev'] = aandelen_data['waarde_verdeling_tov_min1'].rolling(4).std().shift(-3)
        aandelen_data['waarde_verdeling_mean'] = aandelen_data['waarde_verdeling_tov_min1'].rolling(4).mean().shift(-3)
        aandelen_data['waarde_verdeling'] = (aandelen_data['waarde_verdeling1'] * (1+ aandelen_data['waarde_verdeling_mean'])) / (1+ aandelen_data['waarde_verdeling_stdev'])
        ...
        aandelen_data.loc[aandelen_data['period_end_date'].shift(-43) > aandelen_data['period_end_date'] - pd.DateOffset(years=11) + pd.DateOffset(days=30), 'ontbrekende_data'] = (44 - aandelen_data['StockholdersEquity'].rolling(44).count().shift(-43)) + (44 - aandelen_data['NetIncomeLoss'].rolling(44).count().shift(-43)) + (44 - aandelen_data['NetCashProvidedByUsedInOperatingActivities'].rolling(44).count().shift(-43)) + (44 - aandelen_data['PurchasesOfPropertyAndEquipment'].rolling(44).count().shift(-43)) + (44 - aandelen_data['Revenues'].rolling(44).count().shift(-43)) + (44 - aandelen_data['Dividend'].rolling(44).count().shift(-43)) + (4 - aandelen_data['LiabilitiesCurrent'].rolling(4).count().shift(-3)) + (4 - aandelen_data['Liabilities'].rolling(4).count().shift(-3)) + (4 - aandelen_data['WeightedAverageNumberOfDilutedSharesOutstanding'].rolling(4).count().shift(-3))
